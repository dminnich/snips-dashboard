...
import { getStatusColor, MONTHS_LEFT, MONTHS_RIGHT, SUMMER_WEEKS } from './dates'
...
describe('MONTHS_LEFT', () => {
  it('contains January through May', () => {
    expect(MONTHS_LEFT).toEqual(['January', 'February', 'March', 'April', 'May'])
  })
})

describe('MONTHS_RIGHT', () => {
  it('contains August through December', () => {
    expect(MONTHS_RIGHT).toEqual(['August', 'September', 'October', 'November', 'December'])
  })
})
